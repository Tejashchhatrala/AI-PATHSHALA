    ...
    <section className="py-24 bg-slate-50">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-3xl md:text-5xl font-black text-slate-900 leading-tight ${lang === 'GU' ? 'font-gujarati' : ''}`}>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
           {/* Card 1 */}
           <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-2 transition-all group">
              ...
              <h3 className={`text-2xl font-bold text-slate-900 mb-3 ${lang === 'GU' ? 'font-gujarati' : ''}`}>
