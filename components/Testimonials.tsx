      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-lg hover:shadow-xl transition-all relative group">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className={`text-sm text-slate-500 font-medium ${lang === 'GU' ? 'font-gujarati' : ''}`}>
              ...
              <p className={`text-slate-700 leading-relaxed mb-6 font-medium ${lang === 'GU' ? 'font-gujarati' : ''}`}>
                "{lang === 'EN' ? t.text.en : t.text.gu}"
              </p>
              
              <div className="pt-4 border-t border-slate-200 flex items-center gap-2 text-green-700 font-bold bg-green-50/50 p-2 rounded-lg -mx-2">
