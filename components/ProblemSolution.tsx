    ...
    <section className="section section-darker">
      <div className="container">
        ...
        <div className="problem-grid">
          {/* Problem Side */}
          <div className="reveal glass-card" ref={revealRef} style={{ padding: '2rem', borderColor: 'rgba(255, 59, 48, 0.15)' }}>
          ...
          {/* Solution Side */}
          <div className="reveal glass-card" ref={revealRef} style={{ padding: '2rem', borderColor: 'rgba(48, 209, 88, 0.15)' }}>
