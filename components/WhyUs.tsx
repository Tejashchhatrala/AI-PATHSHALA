      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="lg:w-1/2">
            <span className="text-brand-600 font-bold tracking-wider uppercase text-sm bg-white px-3 py-1 rounded-full border border-brand-100 shadow-sm">
              {lang === 'EN' ? "My Personal Promise" : "મારું વ્યક્તિગત વચન"}
            </span>
            
            <h2 className={`text-4xl md:text-5xl font-extrabold text-slate-900 mt-6 mb-8 leading-tight ${lang === 'GU' ? 'font-gujarati' : ''}`}>
              {lang === 'EN' 
            ...
            <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
              ...
              <p className={`font-semibold text-slate-800 ${lang === 'GU' ? 'font-gujarati' : ''}`}>
                {lang === 'EN'
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3 p-3 bg-white rounded-lg border border-slate-200 shadow-sm hover:border-brand-300 hover:shadow-md transition-all cursor-default">
                  ...
                  <span className={`font-medium text-slate-700 ${lang === 'GU' ? 'font-gujarati' : ''}`}>
          ...
          <div className="lg:w-1/2 w-full mt-8 lg:mt-0">
            <div className="relative bg-brand-900 rounded-3xl p-8 md:p-12 shadow-2xl text-white overflow-hidden transform hover:scale-[1.01] transition-transform duration-500 cursor-default">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-10 bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 text-center hover:bg-white/20 transition-colors">
